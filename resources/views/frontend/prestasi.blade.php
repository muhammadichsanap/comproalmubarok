                ...
                @foreach($prestasis as $prestasi)
                    <div class="col-md-12 mb-3">
                        <div class="card" style="max-width: 750px;">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="{{ asset('images/'.$prestasi->gambar) }}" class="img-fluid rounded-start" alt="{{ $prestasi->nama_siswa }}">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">{{ $prestasi->nama_siswa }}</h5>
                                        <p class="card-text">{{ $prestasi->prestasi }}</p>
                                        <p class="card-text"><small class="text-body-secondary">Last updated {{ $prestasi->created_at->diffForHumans() }}</small></p>
                                    </div>
                                </div>
                            </div>
                        </div>
